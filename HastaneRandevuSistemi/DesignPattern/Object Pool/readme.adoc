...
- Projede sisteme giren hasta sayısını sınırlandırmak için opject pool design pattern kullanıldı. Sisteme aynı anda sınırlı sayıda hasta giriş yapabilecektir.
